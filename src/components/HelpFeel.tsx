...
export default function HelpFeel() {
  return (
    <div className="help-you">
      <h2>We're here to help you feel better.</h2>
      <ul>
        <li>
          <Button className="setres" onClick={() => "?"} type="button">
            <Card className="card-stres">
              <CardHeader className="card-icons">
                <BandageIcon/>
              </CardHeader>
              <CardContent>
                <h3>Stress less</h3>
